(function(){
 function render(){if(state.maineView==='clients')return CoBook.maineClients.render();return shell(`<section class="hero"><div class="eyebrow">КАБИНЕТ МАСТЕРА</div><h1>Главная</h1><button class="premium" data-action="maine-clients" type="button"><span class="premium-title">Клиенты</span><span class="premium-meta">Управление клиентской базой</span></button></section>`)}
