(function(){
 function render(){
   if(state.maineView==='clients')return CoBook.maineClients.render();
 ...
 function handle(action,e){
   if(action==='maine-clients'){
     state.maineView='clients';
     state.clientView='list';
     state.selectedClientId=null;
     return window.render();
   }
   if(action==='maine-finance')return;
   if(CoBook.maineClients&&typeof CoBook.maineClients.handle==='function')return CoBook.maineClients.handle(action,e)
 }
